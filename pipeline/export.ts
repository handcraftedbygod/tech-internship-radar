...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,600;9..144,700&family=IBM+Plex+Mono:wght@400;500;600&display=swap"
    rel="stylesheet"
  />
  ...
  />
  <style>
    body { font-family: "General Sans", system-ui, sans-serif; max-width: 40rem; margin: 2.5rem auto; padding: 0 1.25rem; background: #0b0d12; color: #e6e8eb; }
    a { color: inherit; }
    h1 { font-family: "Fraunces", "General Sans", system-ui, serif; font-size: 1.6rem; font-weight: 700; letter-spacing: -0.01em; margin-bottom: 0.25rem; }
    p.back { margin-top: 0; }
    p.desc { color: #8a90a0; }
    p.hint { background: #12151c; border: 1px solid #1c2029; border-radius: 8px; padding: 0.75rem 1rem; font-size: 0.9rem; }
    p.hint code { background: #1c2029; padding: 0.1rem 0.35rem; border-radius: 4px; font-family: "IBM Plex Mono", monospace; }
    ul { list-style: none; padding: 0; }
    li { padding: 0.85rem 0; border-bottom: 1px solid #1c2029; }
    li a { font-weight: 600; text-decoration: none; }
    li a:hover { text-decoration: underline; }
    li span { display: block; color: #8a90a0; font-size: 0.85rem; margin-top: 0.15rem; font-family: "IBM Plex Mono", monospace; }
  </style>
</head>
<body>
